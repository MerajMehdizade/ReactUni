    ...
    return (
        <>
            <div className="w-full h-full space-y-4 p-3" dir="rtl" >
                    ...
                    <div className="flex justify-between items-center px-5 py-3">
                        <div className="flex flex-col md:flex-row justify-between items-center gap-3">
                            ...
                            <div className="space-y-1 text-center md:text-start">
                                <h4 className="text-sm font-bold">تحویل شده</h4>
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-center gap-3">
                            ...
                            <div className="space-y-1 text-center md:text-start">
                                <h4 className="text-sm font-bold">در حال ارسال</h4>
                                <span className="text-[12px] text-gray-500" >2 سفارش</span>
                            </div>
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-center gap-3">
                            ...
                            <div className="space-y-1 text-center md:text-start">
                                <h4 className="text-sm font-bold">مرجوعی</h4>
                                <span className="text-[12px] text-gray-500" >2سفارش</span>
                            </div>
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-center gap-3">
                            ...
                            <div className="space-y-1 text-center md:text-start">
                                <h4 className="text-sm font-bold">لغو شده</h4>
                                <span className="text-[12px] text-gray-500" >2سفارش</span>
                            </div>
                ...
                <div className="border border-gray-300 rounded-2xl shadow-md h-full p-5">
                        ...
                        <table className="w-full text-sm  text-center border-collapse">
                            ...
                            <tbody>
                                {orders.map((order) => (
                                    ...
                                    >
                                        <td className="py-3 text-[10px] md:text-sm">{order.id}</td>
                                        <td className="py-3 text-[10px] md:text-sm">{order.orderNumber}</td>
                                        <td className="py-3 text-[10px] md:text-sm">{order.date}</td>
                                        <td className="py-3 text-[10px] md:text-sm">{order.amount}</td>
                                        <td className="py-3 ">
                                            <span
                                                className={`h-10 w-10 px-3 py-2 text-[8px] md:text-[12px] rounded-full text-xs font-medium ${order.color}`}
                                            >
                                                {order.status}
                                            </span>
                                        </td>
